...
int main(int argc, char *argv[]) {
  ...
  biblioteca.add(new Libro("El Principito", "w", "un libro molto bello",
  ...
  biblioteca.add(new Libro("El Principito", "arg", "un libro molto bello",
                           "editore", "33838", autori, 1900));
  biblioteca.add(new Libro(" Principito", "f", "un libro molto bello",
                           "editore", "33838", autori, 1900));
  ...
  biblioteca.add(new Libro("cipito", "becwllo", "un libro molto bello",
                           "editore", "33838", {"autor2", "autor3"}, 1900));
