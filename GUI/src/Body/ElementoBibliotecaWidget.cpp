...
#include "../../header/Body/ElementoBibliotecaWidget.h"
#include "qboxlayout.h"
#include "qcoreapplication.h"
#include "qlabel.h"
#include <QTextBlock>

ElementoBibliotecaWidget::ElementoBibliotecaWidget() {}

ElementoBibliotecaWidget::~ElementoBibliotecaWidget() { delete widget; }

QWidget *ElementoBibliotecaWidget::getWidget() const { return widget; }

void ElementoBibliotecaWidget::visit(Libro *libro) {
  widget = new QWidget();
...
void ElementoBibliotecaWidget::visit(Brano *brano) {
  widget = new QWidget();
  QHBoxLayout *layout = new QHBoxLayout();
  QLabel *info = new QLabel("Info sull'elemento", widget);
  QLabel *pixmap = new QLabel;
...
void ElementoBibliotecaWidget::visit(Film *film) {
  widget = new QWidget();
  QHBoxLayout *layout = new QHBoxLayout();
  QLabel *info = new QLabel("Info sull'elemento", widget);
  QLabel *pixmap = new QLabel;
